  ...
  return (
    <div id="print-section" className="w-full max-w-[794px] mx-auto bg-white text-slate-900 p-8 shadow-sm border border-slate-200 print:border-0 print:shadow-none print:p-6 print:max-w-none text-xs font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <div className="flex justify-between items-start border-b-2 border-slate-800 pb-4">
        <div>
          <span className="inline-block px-2.5 py-0.5 rounded text-[10px] font-extrabold uppercase tracking-wider bg-indigo-100 text-indigo-800 border border-indigo-200 mb-1.5">
            PURCHASE INWARD VOUCHER / BILL
          </span>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">{business.name || 'RAHUL JEE TRADING COMPANY'}</h1>
        ...
        <div className="text-right space-y-1.5 bg-slate-50 p-3 rounded-xl border border-slate-200 min-w-[210px]">
          <div>
            ...
            <p className="font-mono font-extrabold text-sm text-indigo-700">{purchase.billNumber}</p>
          </div>
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Inward Bill Date</p>
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Bill Status</p>
            <span
